...
tests = [ {'description': 'PINA: 0x00 => PORTB: 0x00, PORTC:0x00',
    ...
    {'description': 'PINA: 0x04, 0x00, 0x02, 0x00  => PORTB: 0x01, PORTC: 0x03',
    ...
    {'description': 'PINA: 0x00, 0x04, 0x02, 0x00  => PORTB: 0x01, PORTC: 0x03',
    ...
    {'description': 'PINA: 0x00, 0x04, 0x02, 0x00, 0x80, 0x00 => PORTB: 0x00, PORTC: 0x04',
    'steps': [ {'inputs': [('PINA', 0x00)],'iterations': 1}, # Set PIN to val then run one iteration
               {'inputs': [('PINA', 0x04)],'iterations': 1}, 
               {'inputs': [('PINA', 0x02)],'iterations': 1}, 
               {'inputs': [('PINA', 0x00)],'iterations': 1}, 
    ...
    {'description': 'PINA: 0x00, 0x04, 0x01 => PORTB: 0x00, PORTC: 0x02',
    'steps': [ {'inputs': [('PINA', 0x00)],'iterations': 1}, # Set PIN to val then run one iteration
               {'inputs': [('PINA', 0x04)],'iterations': 1}, 
    ...
    {'description': 'PINA: 0x00, 0x04, 0x00, 0x02, 0x00 => PORTB: 0x01, PORTC: 0x03',
    'steps': [ {'inputs': [('PINA', 0x00)],'iterations': 1},
	       {'inputs': [('PINA', 0x04)],'iterations': 1},  
               {'inputs': [('PINA', 0x00)],'iterations': 1}, 
               {'inputs': [('PINA', 0x02)],'iterations': 1}, 
    ...
    {'description': 'PINA: 0x80, 0x00, 0x04, 0x03 => PORTB: 0x00, PORTC: 0x02',
    'steps': [ {'inputs': [('PINA', 0x80)],'iterations': 1}, # Set PIN to val then run one iteration
               {'inputs': [('PINA', 0x00)],'iterations': 1}, 
               {'inputs': [('PINA', 0x04)],'iterations': 1}, 
